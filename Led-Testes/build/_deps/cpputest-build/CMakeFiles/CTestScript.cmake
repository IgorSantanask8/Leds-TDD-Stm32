...
# CTest Start Step
set(CTEST_SOURCE_DIRECTORY "/c/Users/santa/Embbebed/Led-Testes/thirdy-party/cpputest")
set(CTEST_BINARY_DIRECTORY "/c/Users/santa/Embbebed/Led-Testes/build/_deps/cpputest-build")

# CTest Update Step
set(CTEST_UPDATE_COMMAND "/usr/bin/git.exe")
...
# Git options
set(CTEST_GIT_COMMAND "/usr/bin/git.exe")
...
# CTest Coverage Step
set(CTEST_COVERAGE_COMMAND "/mingw32/bin/gcov.exe")
...
# CTest Submit Step
set(CTEST_SITE "LAPTOP-T7F2SCR2")
set(CTEST_BUILD_NAME "MSYS-c++.exe")
