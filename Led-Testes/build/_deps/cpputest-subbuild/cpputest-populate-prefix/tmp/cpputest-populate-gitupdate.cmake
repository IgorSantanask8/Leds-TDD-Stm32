...
execute_process(
  COMMAND "/usr/bin/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "/c/Users/santa/Embbebed/Led-Testes/thirdy-party/cpputest"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/c/Users/santa/Embbebed/Led-Testes/thirdy-party/cpputest'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/c/Users/santa/Embbebed/Led-Testes/thirdy-party/cpputest'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
